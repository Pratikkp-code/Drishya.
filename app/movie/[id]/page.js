                ...
                <CardContent>
                  {hasRental ? (<div className="text-center py-6"><div className="bg-teal-500/10 border border-teal-500/20 rounded-lg p-4"><p className="text-teal-300 font-semibold">You already have an active rental.</p><p className="text-gray-400 text-sm">You can watch the movie now.</p></div></div>) : (
                    <div className="space-y-4">
                      <div className="text-center border-b border-gray-700 pb-4"><p className="text-gray-400 text-sm">Price Per Day</p><p className="text-2xl font-bold text-teal-400">{formatPrice(movie.pricePerDay)} <span className="text-lg">PAS</span></p></div>
                      ...
                      <div className="text-center pt-3">
                        ...
                        <p className="text-4xl font-bold text-teal-400">{formatPrice(totalCost)} <span className="text-2xl">PAS</span></p>
                        {hasActiveDiscount && (<p className="text-xs text-gray-500 line-through">Original: {formatPrice(movie.pricePerDay * BigInt(rentalDays))} PAS</p>)}
                      </div>
